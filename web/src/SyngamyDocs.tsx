...
export const SECTIONS: DocSection[] = [
  { id: 'what', label: 'What this answers', group: 'Overview' },
  { id: 'why', label: 'Why the variant site cannot answer it', group: 'Overview' },
  { id: 'biology', label: 'The biology, from first principles', group: 'Overview' },
  { id: 'array', label: 'What a SNP array actually measures', group: 'Overview' },
  { id: 'using', label: 'Using the page', group: 'Overview' },
  { id: 'formats', label: 'File formats it accepts', group: 'Overview' },
  { id: 'axes', label: 'The three measurements', group: 'Method' },
  { id: 'bound', label: 'The noise bound, derived per sample', group: 'Method' },
  { id: 'unrelated', label: 'The constant that had to be abandoned', group: 'Method' },
  { id: 'classes', label: 'Reading the verdict', group: 'Method' },
  { id: 'band', label: 'The uncalled band', group: 'Method' },
  { id: 'chrx', label: 'Sperm type from chrX, not chrY', group: 'Method' },
  { id: 'oocyte', label: 'Adding the oocyte donor', group: 'Method' },
  { id: 'inferred', label: 'When the donor array is reconstructed', group: 'Method' },
  { id: 'locus', label: 'The per-locus deletion test', group: 'Method' },
  { id: 'confidence', label: 'Confidence, and why no percentage', group: 'Method' },
  { id: 'gates', label: 'Quality gates', group: 'Quality checks' },
  { id: 'assembly', label: 'Assembly detection, and no liftOver', group: 'Quality checks' },
  { id: 'chrom', label: 'Per-chromosome and segmental results', group: 'Chromosomal changes' },
  { id: 'aneuploidy', label: 'Aneuploidy: whole chromosomes', group: 'Chromosomal changes' },
  { id: 'breakpoints', label: 'How precisely a breakpoint is placed', group: 'Chromosomal changes' },
  { id: 'gainorigin', label: 'Where an extra copy came from', group: 'Chromosomal changes' },
  { id: 'segments', label: 'Chromosomal change: segments', group: 'Chromosomal changes' },
  { id: 'contribution', label: 'One parent or two, per chromosome', group: 'Chromosomal changes' },
  { id: 'oneparent', label: 'Parental origin from one parent', group: 'Chromosomal changes' },
  { id: 'dosage', label: 'Whole chromosomes, from allele dosage', group: 'Chromosomal changes' },
  { id: 'taxonomy', label: 'Every class, and the ones that cannot be answered', group: 'Chromosomal changes' },
  { id: 'comparison', label: 'Feature comparison, and why it is optional', group: 'Chromosomal changes' },
  { id: 'stage', label: 'Material, amplification and stage', group: 'Reference' },
  { id: 'report', label: 'The report, and how to cite it', group: 'Reference' },
  { id: 'examples', label: 'The bundled example data', group: 'Reference' },
  { id: 'backend', label: 'What the backend adds', group: 'Reference' },
  { id: 'cli', label: 'Command line', group: 'Reference' },
  { id: 'validation', label: 'Validation record', group: 'Reference' },
  { id: 'limits', label: 'Scope and limits', group: 'Reference' },
  { id: 'privacy', label: 'Privacy and data handling', group: 'Reference' },

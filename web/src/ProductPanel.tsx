...
import { type Triage } from './productTriage'

// Re-exported so a caller that wants the gate and the table it renders into has one import.
export { ploidyOf, triage, HET_RATE_DIPLOID } from './productTriage'
export type { Ploidy, Triage } from './productTriage'

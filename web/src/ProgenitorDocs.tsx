...
export const SECTIONS: DocSection[] = [
  ...
  { id: 'procedure', label: 'Methods text, for a paper', group: 'Overview' },
  { id: 'method', label: 'The method, and its one error', group: 'Overview' },
  { id: 'products', label: 'What counts as a product', group: 'Overview' },
  { id: 'using', label: 'Using the page', group: 'Overview' },
  { id: 'formats', label: 'File formats it accepts', group: 'Overview' },
  { id: 'quality', label: 'Stage 1: quality and ploidy', group: 'Method' },
  { id: 'membership', label: 'Stage 2: which products share a parent', group: 'Method' },
  { id: 'naming', label: 'Which group is the father\u2019s', group: 'Method' },
  { id: 'origin', label: 'Calling parental origin', group: 'Method' },
  { id: 'depth', label: 'Stage 3: how deep to build', group: 'Method' },
  { id: 'contamination', label: 'Contamination, and the absence it adds', group: 'Checks' },
  { id: 'verify', label: 'Leave-one-out verification', group: 'Checks' },
  { id: 'floor', label: 'The five-product floor', group: 'Checks' },
  { id: 'refusals', label: 'What it refuses to report', group: 'Checks' },
  { id: 'exports', label: 'Exports and the report', group: 'Reference' },
  { id: 'examples', label: 'The bundled example data', group: 'Reference' },
  { id: 'validation', label: 'Validation record', group: 'Reference' },
  { id: 'parity', label: 'Two implementations, one answer', group: 'Reference' },
